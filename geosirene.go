...
func (s GeoSirene) ToArray() []interface{} {
	return []interface{}{
		s.Siren,
		s.Nic,
		s.Siret,
		s.StatutDiffusionEtablissement,
		...
		s.NumeroVoie2Etablissement,
		s.IndiceRepetition2Etablissement,
		s.TypeVoie2Etablissement,
		s.LibelleVoie2Etablissement,
		s.CodePostal2Etablissement,
		s.LibelleCommune2Etablissement,
		s.LibelleCommuneEtranger2Etablissement,
		s.DistributionSpeciale2Etablissement,
		s.CodeCommune2Etablissement,
		s.CodeCedex2Etablissement,
		s.LibelleCedex2Etablissement,
		s.CodePaysEtranger2Etablissement,
